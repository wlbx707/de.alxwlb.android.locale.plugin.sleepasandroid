 ...
 */
package de.alxwlb.android.locale.plugin.sleepasandroid.ui;
...
import de.alxwlb.android.locale.plugin.sleepasandroid.bundle.BundleScrubber;
import de.alxwlb.android.locale.plugin.sleepasandroid.bundle.PluginBundleManager;
import de.alxwlb.android.locale.plugin.sleepasandroid.R;
...
public final class EditActivity extends Activity
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        if (null == savedInstanceState)
        {
            ...
            {
                mList.setItemChecked(getPositionForIdInArray(getApplicationContext(), R.array.display_states, forwardedBundle.getBoolean(PluginBundleManager.BUNDLE_EXTRA_BOOLEAN_STATE) ? R.string.list_on
                        : R.string.list_off), true);
            }
        }
        /*
    ...
    public void finish()
    {
        if (!mIsCancelled && AdapterView.INVALID_POSITION != mList.getCheckedItemPosition())
        {
            ...
            if (R.string.list_on == selectedResourceId)
            {
                ...
                resultIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB, getString(R.string.blurb_on));
            }
            else if (R.string.list_off == selectedResourceId)
            {
                resultBundle.putBoolean(PluginBundleManager.BUNDLE_EXTRA_BOOLEAN_STATE, false);
                resultIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB, getString(R.string.blurb_off));
            }
            else
            {
